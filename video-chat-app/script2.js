...
let config = {
    ...
    token:'007eJxTYCg78qD6+/T6ra0+aqLXE3fKc5fxxbmv6DWcYfnKn8dV7q0Cg5mFuZGJcZpJYkqysUmKUZplooWlpbm5eZqxeWpyoqWBc/P75IZARgYWlicMjFAI4rMxJKbnZZalMzAAADEmHpA=',
    uid:null,
    channel:'agnivg',
}
...
const emotions = {
    ...
    disgusted: "./assets/disgust.svg",
    fearful: "./assets/fearful.svg",
    neutral: "./assets/neutral.svg",
    surprised: "./assets/surprised.svg",
    sad: './assets/sad.svg'
};
...
function startVideoAndAudio(){
    ...
    const loop = async () => {
        let videoEl = document.getElementById("cameraPreview");
    ...
    function startCapture() {
        ...
        .then((stream) => {
            ...
            cameraPreview.onloadedmetadata = loop;
    ...
    async function getDuration(audioBlob) {
